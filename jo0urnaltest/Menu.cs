...
namespace jo0urnaltest
{
    class Menu
    {
        public void AddMenuItems()
        {
            ...
            oCreationPackage.UniqueID = "jo0urnaltest";
            oCreationPackage.String = "jo0urnaltest";
            ...
            try
            {
                ...
                oMenuItem = Application.SBO_Application.Menus.Item("jo0urnaltest");
                oMenus = oMenuItem.SubMenus;

                // Create s sub menu
                oCreationPackage.Type = SAPbouiCOM.BoMenuType.mt_STRING;
                oCreationPackage.UniqueID = "jo0urnaltest.Form1";
        ...
        public void SBO_Application_MenuEvent(ref SAPbouiCOM.MenuEvent pVal, out bool BubbleEvent)
        {
            ...
            try
            {
                if (pVal.BeforeAction && pVal.MenuUID == "jo0urnaltest.Form1")
                {
